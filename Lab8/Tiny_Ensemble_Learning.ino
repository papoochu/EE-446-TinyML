...
float standard_stds[6]  = {4.253204f,  5.397565f, 6.433631f,  0.325429f,  0.571098f,  0.542104f};
float minmax_mins[6]    = {-22.091000f, -19.570999f, -19.363001f, -0.977740f, -1.611600f, -1.206300f};
float minmax_maxs[6]    = { 20.003000f,  20.909000f,  24.599001f,  1.463800f,  1.557200f,  1.326100f};
